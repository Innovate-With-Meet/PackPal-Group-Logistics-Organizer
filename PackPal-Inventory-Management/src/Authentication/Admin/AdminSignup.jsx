...
export const AdminSignup = (props) => {
    ...
    const handleSubmit = async (event) => {
        ...
        const role_id = "67facc95885c025631cd7720"
        // const role_id = "67facc95885c025631cd7720"


        try {
            const response = await axios.post("http://localhost:8000/create_user", { firstName, lastName, email, password, role_id }); //
            ...
            <AdminRegistrationContainer direction="column" justifyContent="space-between">
                <Card variant="inlined">
                    ...
                    <Box component="form" onSubmit={handleSubmit} sx={{ display: "flex", flexDirection: "column", gap: 2 }}>
                        ...
                        <FormControl>
                            <FormLabel htmlFor="name">Admin First Name</FormLabel>
                            <TextField sx={{ width: "390px" }} autoComplete="name" name="firstName" required fullWidth id="name" placeholder="Jon" error={nameError} helperText={nameErrorMessage} color={nameError ? "error" : "primary"} />
                        </FormControl>

                        <FormControl>
                            <FormLabel htmlFor="name">Admin Last Name</FormLabel>
                            <TextField sx={{ width: "390px" }} autoComplete="name" name="lastName" required fullWidth id="name" placeholder="Snow" error={nameError} helperText={nameErrorMessage} color={nameError ? "error" : "primary"} />
                        </FormControl>
