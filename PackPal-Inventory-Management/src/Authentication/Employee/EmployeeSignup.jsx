...
const EmployeeRegistrationContainer = styled(Stack)(({ theme }) => ({
...
export const EmployeeSignup = (props) => {
    ...
    const [employeeIdErrorMessage, setEmployeeIdErrorMessage] = React.useState("");
    ...
    const validateInputs = () => {
        ...
        if (!employeeId.value || employeeId.value.length < 1) {
            setEmployeeIdError(true);
            setEmployeeIdErrorMessage("Employee ID is required.");
            isValid = false;
        } else {
    ...
    const handleSubmit = async (event) => {
        ...
        if (nameError || emailError || passwordError || employeeIdError) {
            return;
        }
        ...
        try {
            const response = await axios.post("http://localhost:8000/employee", { name, email, password, employeeId });
    ...
    return (
        <AppTheme {...props}>
            ...
            <EmployeeRegistrationContainer direction="column" justifyContent="space-between">
                <Card variant="inlined">
                    ...
                    <Box component="form" onSubmit={handleSubmit} sx={{ display: "flex", flexDirection: "column", gap: 2 }}>
                        ...
                        <FormControl>
                            <FormLabel htmlFor="employeeId">Unique Employee ID</FormLabel>
                            <TextField sx={{ width: "390px" }} autoComplete="employeeId" name="employeeId" required fullWidth id="employeeId" placeholder="E12345" error={employeeIdError} helperText={employeeIdErrorMessage} color={employeeIdError ? "error" : "primary"} />
                        </FormControl>

                        <FormControl>
                            <FormLabel htmlFor="name">Employee Full Name</FormLabel>
                            <TextField sx={{ width: "390px" }} autoComplete="name" name="name" required fullWidth id="name" placeholder="John Doe" error={nameError} helperText={nameErrorMessage} color={nameError ? "error" : "primary"} />
                        </FormControl>
